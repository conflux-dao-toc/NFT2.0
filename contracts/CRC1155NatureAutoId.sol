...
contract CRC1155NatureAutoId is AccessControlEnumerable, CRC1155Enumerable, CRC1155Metadata, InternalContractsHandler {
    ...
    function setURI(string memory newuri) public virtual {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "CRC1155NatureAutoId: must have admin role to set URI");
        _setURI(newuri);
    }
